...
CREATE TABLE "new_habit-week-days" (
...
INSERT INTO "new_habit-week-days" ("habit_id", "id", "week_day") SELECT "habit_id", "id", "week_day" FROM "habit-week-days";
DROP TABLE "habit-week-days";
ALTER TABLE "new_habit-week-days" RENAME TO "habit-week-days";
